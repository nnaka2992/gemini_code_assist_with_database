...
We follow Prisma's standard naming conventions, using the same names in both the Prisma schema and the database.

| Element | Prisma Schema & Database | Example |
| Model/Table | PascalCase, Singular | model User |
| Field/Column | camelCase | field firstName |
| Foreign Key | camelCase (e.g., authorId) | authorId String |
